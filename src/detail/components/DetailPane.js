            ...
            <Container>
                <div className="card mt-3 mb-1">
                    ...
                    <div className="card-body">
                        ...
                        <h6 className="card-subtitle mb-2 pb-3 text-muted" style={{borderBottom: '1px solid #e9ecef'}}>2022.05.01 ~ 2024.04.30</h6>
                    <div className="row">
                        <div className="col">
                            <p className="card-text" style={{fontWeight: 'bold'}}>100,000,000 원</p>
                        </div>
                        <div className="col-2 mx-1" style={{textAlign: 'end'}}>
                            <img src="./icons/icon-more.svg" className="img-fluid" style={{width: '20px'}}/>
                        </div>
                    </div>
                    </div>
                </div>
                ...
                <div className="row my-4">
                    <div className="col" style={{textAlign: 'center'}}>
                        <img src="./icons/icon-plus.svg" className="img-fluid" style={{width: '20px'}} />
                    </div>
                </div>
            </Container>
        )
